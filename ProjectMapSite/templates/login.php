    ...
    <main>
        <div class="text-center">
            ...
            <form class="form-group" action="../includes/login.inc.php" method="post">
                ...
                <br><br>
                <a href="../templates/signup.php">No account? Register here!</a>
                <br><br>
                <a href="../templates/passwordrecovery.php">Forgotten password?</a>
                <br><br>
                <a href="../public/index.php">Login as guest?</a>
                <br><br>
